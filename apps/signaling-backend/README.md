...
- Roulette waiting queue, active match records, match leave handling, reason-coded report/block moderation records, admin review queue with resolution status, and block-aware rematching.
