...
- Added automatic local debug session logging with downloadable cleaned metrics for ROI, quality gates, method estimates, and badge state.
- Tuned timestamp reliability to tolerate browser frame jitter while still rejecting true capture gaps, and constrained full-frame skin fallback ROI.
