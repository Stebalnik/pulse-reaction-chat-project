...
- `knowledge/papers/PAPER-2021-FINE-PPG-INACCURACY.md`: waveform-derived cardiovascular features require high-quality PPG morphology and are affected by population, physiology, and external perturbations.
...
PRV, HRV, and BP-like waveform features require reliable pulse waveform and timing, not just approximate average HR. Available evidence is useful but not sufficient for launch UI.

## product_implication

Keep PRV-like and BP-like features out of first launch UI and behind benchmark gates plus safety review.
